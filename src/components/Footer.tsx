        ...
        <div className="bg-slate-800 text-white py-8">
            <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between space-y-6 md:space-y-0">
                ...
                <div className="text-left">
                    ...
                    <p className="text-sm mt-2 max-w-md">Incredible, sustainably sourced tea delivered fresh from the best roasters in the nation.</p>
                    <div className="flex gap-4 mt-4">
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                            <img src={facebookLogo} alt="facebook" className="w-6 hover:opacity-80 transition" />
                        </a>
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
                            <img src={instagramLogo} alt="instagram" className="w-6 hover:opacity-80 transition" />
                        </a>
                    </div>
                </div>
                ...
                <div className="text-left">
                    ...
                    <div className="flex gap-12 mt-4">
                        ...
                        <div>
                            <p className="hover:text-gray-400 cursor-pointer">RECOMMENDATION</p>
